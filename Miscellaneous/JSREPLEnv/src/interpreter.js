...
const ERRORS = {
  syntax: [],
  logic: ["More than 1 entry point detected"],
  runtime: [],
};
...
export class jsSession {
  ...
  raise(line, type, code) {
    console.log(
      build_error(this.lines, line, type, code, this.filename, this.lnCount),
    );
  }
}
